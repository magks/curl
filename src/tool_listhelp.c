...
const struct helptxt helptext[] = {
  ...
  {"    --remote-name-all",
   ...
   CURLHELP_OUTPUT},
  {"-W, --remote-name-decode",
   "Write output to a file named as the remote file percent-decoded",
   CURLHELP_OUTPUT},
  {"    --remote-name-decode-all",
   "Use the remote file name percent-decoded for all URLs",
   CURLHELP_OUTPUT},
  {"-R, --remote-time",
